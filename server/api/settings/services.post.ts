...
import { SERVICE_SETTING_KEYS, updateServiceSettings } from '../../utils/serviceSettings'
...
export default defineEventHandler(async (event) => {
  ...
  if (!body || typeof body !== 'object' || SERVICE_SETTING_KEYS.some(key => body[key] !== undefined && (typeof body[key] !== 'string' || body[key].length > 4096)))
